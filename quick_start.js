...
//     getAudioDevicesButton.addEventListener("click", getAudioDevices);
//     speakerDevices.addEventListener("change", updateOutputDevice);
//     ringtoneDevices.addEventListener("change", updateRingtoneDevice);
...
//             outgoingCallHangupButton.addEventListener("click", function () {
//                 log("Hanging up ...");
//                 call.disconnect();
//             });
//         } else {
...
//         incomingCallAcceptButton.addEventListener("click", function () {
//             acceptIncomingCall(call);
//         });

//         incomingCallRejectButton.addEventListener("click", function () {
//             rejectIncomingCall(call);
//         });

//         incomingCallHangupButton.addEventListener("click", function () {
//             hangupIncomingCall(call);
//         });
